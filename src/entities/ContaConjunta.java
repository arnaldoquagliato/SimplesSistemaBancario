...
public class ContaConjunta extends ContasBancarias{
	...
	public ContaConjunta(int id, String numeroConta, double saldoConta, int agencia) {
	...
	public void pagarConta(ArrayList<ContasBancarias> listaContasBancarias) {
		...
		if (valorPagamento > contaCorrenteValidada(listaContasBancarias).getSaldoConta()+ getLimite()) {
				...
				if(contaCorrenteValidada(listaContasBancarias).getSaldoConta() > valorPagamento) {
					...
					contaCorrenteValidada(listaContasBancarias).setSaldoConta(contaCorrenteValidada(listaContasBancarias).getSaldoConta()+getLimite() - valorPagamento);
				}
